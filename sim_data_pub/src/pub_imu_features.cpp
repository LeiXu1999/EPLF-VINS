...
int main(int argc, char **argv)
{
    ...
    ros::Publisher pub_pobs = n.advertise<sensor_msgs::PointCloud>("/lf_feature_tracker/feature", 1000);
    ros::Publisher pub_lobs = n.advertise<sensor_msgs::PointCloud>("/lf_linefeature_tracker/linefeature", 1000);
    ...
    LoadPose("/home/shitong/outputimu_pose.txt",imutimestamp, gyros, accs);
    LoadPose("/home/shitong/outputcam_pose.txt",camtimestamp, temp1, temp2);
    ...
    for (int i = 0; i < imutimestamp.size(); ++i)
    {
        ...
        {
            stringstream ss;
            ss << "/home/shitong/outputkeyframe/all_points_"<< cam_time_index <<".txt";
            std::vector<Eigen::Vector2d> pobs;
            LoadPointObs(ss.str(),pobs);

            stringstream ss1;
            ss1 << "/home/shitong/outputkeyframe/all_lines_"<< cam_time_index <<".txt";
