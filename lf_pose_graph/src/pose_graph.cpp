...
int PoseGraph::detectLoop(KeyFrame *keyframe, int frame_index)
{
    ...
    */
    ofstream fout("/home/jiangdi/EPLF_WS/EPLF_VINS_WS/src/Trajactory/detec_loop.csv", ofstream::app);
    fout << tmp_t.toc() << endl;
    fout.close();
    ...
    while (true)
    {
        ...
        if (cur_index != -1)
        {
            ...
            */
            ...
            ofstream foutC("/home/jiangdi/result_output/time/euroc/EPLF_VINS_WS/eplfvins_pose_garph_optimize.csv", ios::app);
            foutC << t_r.toc() << endl;
            foutC.close();
        }
